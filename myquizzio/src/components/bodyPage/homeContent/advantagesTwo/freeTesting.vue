<template>
    <b-container class="freetesting">
  <b-row>
    <b-col>
        <b-img :src="LienImage[0]" fluid alt="Fluid image" max-height="550" max-width="600"></b-img>
    </b-col>
    <b-col>
...
<script>
import TestingBouton from '../../homeCaroussel/carousselButton.vue'
    export default {
        name:'freeTestingContent',
        data(){
            return{
